...
@Component({
  selector: 'app-kolone-partnera',
  templateUrl: './kolone-partnera.component.html',
  styleUrls: ['./kolone-partnera.component.scss']
})
export class KolonePartneraComponent implements OnInit 
{
