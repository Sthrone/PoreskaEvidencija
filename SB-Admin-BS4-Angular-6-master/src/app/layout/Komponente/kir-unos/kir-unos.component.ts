...
@Component({
  selector: 'app-kir-unos',
  templateUrl: './kir-unos.component.html',
  styleUrls: ['./kir-unos.component.scss'],
  animations: [routerTransition()]
})
export class KirUnosComponent implements OnInit 
{
  kir: Kir;
  partneri: Partner[];
  ...
  InicijalizujRacun()
  {
    ...
    this.kir.datum_knjizenja_isprave = datum;
    this.kir.datum_racuna = datum;
    this.kir.ukupna_naknada_sa_pdv = 0.00;
    this.kir.ukupni_promet_sa_i_bez_prava_na_pdv = 0.00;
    this.kir.promet_sa_pravom_na_pdv = 0.00;
    this.kir.osnovica_20 = 0.00;
    this.kir.pdv_20 = 0.00;
    this.kir.osnovica_10 = 0.00;
    this.kir.pdv_10 = 0.00;
    this.kir.oslobodjeni_promet_sa_odbitkom = 0.00;
    this.kir.oslobodjeni_promet_bez_odbitka = 0.00;
    this.kir.promet_u_inostranstvu_sa_pravom_na_odbitak = 0.00;
    this.kir.promet_u_inostranstvu_bez_naknade = 0.00;
