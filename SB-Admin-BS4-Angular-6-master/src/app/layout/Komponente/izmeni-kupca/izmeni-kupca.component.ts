...
@Component({
  selector: 'app-izmeni-kupca',
  templateUrl: './izmeni-kupca.component.html',
  styleUrls: ['./izmeni-kupca.component.scss'],
  animations: [routerTransition()]
})
export class IzmeniKupcaComponent implements OnInit 
{ 
  p: Partner;
  ...
  { 
    ...
    {
      this.stareVrednosti = Partner.FromJSON(JSON.parse(params['kupac']));
    ...
    if (p1 && p2 && p3 && p4)
    {
      ...
      this.dijalogRef.afterClosed().subscribe((res) => 
      {
        if (res == true)
        {
          ...
          this.toastr.info(this.translate.instant('_95'));
      });
    }
